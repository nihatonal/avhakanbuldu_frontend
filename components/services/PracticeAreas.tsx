                            ...
                            >
                                <Card className="card-elegant relative hover:shadow-accent/20 h-full">
                                    ...
                                    <div className="p-4 flex flex-col h-full">
                                        ...
                                        <Link href={`/faaliyet-alanlari/${area.slug}`} className=" flex items-center py-2 px-4 rounded-full ml-auto bg-accent/80 cursor-pointer text-accent text-white hover:bg-accent/100">
